...
const ImageMask = React.forwardRef(({ className, images, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={className} {...props}>
      ...
      {/* Main image grid */}
      <section className='grid grid-cols-3 gap-8 bg-white border rounded-lg p-5'>
        ...
        <figure style={{ clipPath: 'url(#clip-pattern5)' }}>
          <img
            ...
            alt='Camping scene'
            className='transition-all duration-300 aspect-[4/5] min-h-full align-bottom object-cover hover:scale-110 w-full'
            onError={(e) => handleImageError(e, 5)}
          />
        </figure>
        <figure style={{ clipPath: 'url(#clip-pattern6)' }}>
          <img
            ...
            alt='Camping scene'
            className='transition-all duration-300 aspect-[4/5] min-h-full align-bottom object-cover hover:scale-110 w-full'
            onError={(e) => handleImageError(e, 6)}
          />
        </figure>
        <figure style={{ clipPath: 'url(#clip-pattern7)' }}>
          <img
            ...
            alt='Camping scene'
            className='transition-all duration-300 aspect-[4/5] min-h-full align-bottom object-cover hover:scale-110 w-full'
            onError={(e) => handleImageError(e, 7)}
          />
        </figure>
        <figure style={{ clipPath: 'url(#clip-pattern8)' }}>
          <img
            ...
            alt='Camping scene'
            className='transition-all duration-300 aspect-[4/5] min-h-full align-bottom object-cover hover:scale-110 w-full'
            onError={(e) => handleImageError(e, 8)}
          />
        </figure>
      </section>
    </div>
